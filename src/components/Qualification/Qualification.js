        ...
        <div className="qualification__sections">
          ...
          >
            <div className="qualification__data">
              <div>
                <h3 className="qualification__title">Bootcamp Foundation</h3>
                <span className="qualification__subtitle">
                Najot Education Training Center
                </span>
            ...
            <div className="qualification__data qualification__data-right">
              ...
              <div>
                ...
                <div className="qualification__calendar">
                  <i className="uil uil-calendar-alt" /> 2024 - 2025
                </div>
              </div>
            </div>
          </div>
          ...
          >
            <div className="qualification__data qualification__data-right">
              ...
              {/* <div>
                <h3 className="qualification__title">Full-Stack Developer</h3>
                <span className="qualification__subtitle">+2</span>
                <div className="qualification__calendar">
